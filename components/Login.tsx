    ...
    <div className="bg-white rounded-2xl shadow-lg p-6 md:p-8 w-full max-w-md mx-auto text-center relative border-t-8 border-emerald-600">
      ...
      <form onSubmit={handleLogin} className="space-y-6">
        <input
          ...
          required
          className="w-full px-4 py-3 bg-gray-700 text-white rounded-lg border-2 border-transparent focus:outline-none focus:border-emerald-500 placeholder-gray-400"
